class CurrentProjectsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @current_project.save
        ...
        format.json { render :show, status: :created, location: @current_project }
      else
  ...
  def update
    respond_to do |format|
      if @current_project.update(current_project_params)
        ...
        format.json { render :show, status: :ok, location: @current_project }
      else
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to current_projects_url, notice: 'Current project was successfully destroyed.' }
  ...
  private
    ...
    def current_project_params
      params.require(:current_project).permit(:title, :body, :date, :Done)
    end
end
